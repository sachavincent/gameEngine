...
public class AddResourceCommand extends Command {
    ...
    private final static String[] VALID_RESOURCE = new String[]{"FISH", "WHEAT", "BREAD"};
    ...
    private final static LocalExecuteCommandCallback LOCAL_CALLBACK = (resourceName, amount) -> {
        ...
        ResourceManager.addToResource(resource, intAmount);
        return 0;
    };
    ...
    public String getMessageFromResult(int result) {
        ...
        switch (result) {
            ...
            case 0:
                return "Added " + parameterValues.get(1) + " " + parameterValues.get(0).toUpperCase() +
                        " successfully!";
            case 1:
