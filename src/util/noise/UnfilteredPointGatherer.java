...
public class UnfilteredPointGatherer<TTag> {
    ...
    private static final double[] JITTER_SINCOS;
    ...
    public UnfilteredPointGatherer(double frequency, double maxPointContributionRadius) {
        ...
        List<LatticePoint> pointsToSearchList = new ArrayList<>();
    ...
    public List<GatheredPoint<TTag>> getPoints(long seed, double x, double z) {
        ...
        List<GatheredPoint<TTag>> worldPointsList = new ArrayList<>(this.pointsToSearch.length);
        for (LatticePoint point : this.pointsToSearch) {
            ...
            GatheredPoint<TTag> worldPoint = new GatheredPoint<>(scaledX * this.inverseFrequency,
                    scaledZ * this.inverseFrequency, remainingHash);
