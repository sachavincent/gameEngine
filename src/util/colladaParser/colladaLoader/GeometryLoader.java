...
import util.colladaParser.dataStructures.Vertex;
import util.colladaParser.dataStructures.VertexSkinData;
...
public class GeometryLoader {
    ...
    private void readNormals() {
        meshData.getChildren("triangles").forEach(triangleNode -> {
    ...
    private void readTextureCoords() {
        List<XmlNode> triangles = meshData.getChildren("triangles");
