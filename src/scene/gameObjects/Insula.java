...
//        addComponent(new SingleModelComponent(new ModelEntity(OBJGameObjects.INSULA.getTexture())));
...
//        resourceProductionComponent.addResource(Resource.GOLD, 0);
...
//            Map<Resource, Integer> resourcesNeeded = Person.getResourcesNeeded(residenceComponent.getPersons());
...
//
//            double goldProductionRate = Person.getResourcesProduced(residenceComponent.getPersons()).get(Resource.GOLD);
//            resourceProductionComponent.setProductionRate(Resource.GOLD, goldProductionRate);
//
